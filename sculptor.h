...
public:
   ...
   * @details Dado um intervalo, o Voxel existirá sua variável 'is0n' retornar valor 'true'.
   ...
   * @details Dado um intervalo, o Voxel existirá sua variável 'is0n' retornar valor 'false'.
   * @param x0 -> coordenada x inicial
   * @param x1 -> coordenada x final
   * @param y0 -> coordenada y inicial
   * @param y1 -> coordenada y final
   ...
   * @brief Método Inserir Esfera
   * @details Criar uma esfera a partir das coordenadas do centro no espaço
   * e seu respectivo raio obedecendo a condição que se refere a equação de
   * uma esfera.
   * @param xcenter
   * @param ycenter
   * @param zcenter
   ...
   * @details Irá criar um arquivo para visualização da imagem.
   * @param filename
   */
